...
scripted_model = load_pretrained_model("onnx_model/yolov8n.onnx")
...
t1 = time.time()
print("Total time for default building yolov8n:", t1 - t0)

t0 = time.time()
lib_sch = schedule(mod, params, target="nvidia/geforce-rtx-3070", log_file="work_dir/yolov8n_auto_tune_log.json")
t1 = time.time()
print("Total time for auto scheduling yolov8n:", t1 - t0)
